...
def App(cookie):
	...
	# hambat1 = x.text.split('<input type="text" id="tronwallet" name="tronwallet" size="40" placeholder="ExpressCrypto Id or FaucetPay linked Tron wallet" style="width: 100%; max-width: 400px; z-index: 99999; position: relative;" onchange="updateWallet(this.value);" autocomplete="on" value="')[1]
