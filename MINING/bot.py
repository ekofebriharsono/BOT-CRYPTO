...
def App(userid):
	...
	while True:
		...
		verify = requests.get(f"https://thora.world/faucet.php?microwallet=ExpressCrypto&id1=EC-UserId-619418&currency=TRX&startclaim=Start%20claiming&key=0642f{numeric}f59aab752fe2e8f78470d62",headers=headers)
...
try:
	...
	print(f"\n {p}YA-HA!!! \n {q}~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n  {p}[{h}•{p}] IP Kamu {m}: {h}{api['ip']}")
	dompet = 'EC-UserId-619418'
	print(f" {q}~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
